				...
				<div class="navbar-list-container navbar-list-container-1">
					<ul>
						...
						<li>
							...
							<a href="kaamdaar/views/business_profile.php">Business Profile</a>
						</li>
						<li>
							<img class="icon20x20" 
		...
		<div class="content-body">
			...
			<div class="bottom-profile">
				<div>
					...
					<p>Address: <?php echo $user->location ?></p>
				</div>
				
				<div>
					<p>Other info</p>
					<p>Gender: <?php echo $user->gender == "M" ? "Male" : "Female"; ?></p>
					<p>DOB: <?php echo $user->dateJoined; ?></p>
				</div>
			</div>
		</div>
